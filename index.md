...
<div class="card">
  <h2>Right Now</h2>
  <ul>
    <li>Wrapping-up my internship in <strong>data analytics and dashboard development</strong>, working directly with university leadership.</li>
    <li>B.Sc. Computing Science (Specialization), pursuing UAlberta’s <strong>Applied Data Science Certificate</strong> </li>
    <li>Science Internship (Co-op) candidate for 4–16 month placements. </li>
...
<div class="card">
  <h2>What I Bring</h2>
  <ul>
    <li><strong>Data analysis & statistics:</strong> Python, C, SQL, RStudio - EDA, hypothesis testing, and reproducible analysis.</li>
    <li><strong>Data engineering:</strong> cleaning, transformation, and feature engineering on multi-source, multi-year datasets.</li>
    <li><strong>Visualization & reporting:</strong> Power BI, Tableau, and Excel dashboards built for non-technical audience.</li>
...
<div class="card">
  <h2>Let’s Connect</h2>
  <p>I’m always open to data, analytics, and BI-focused opportunities. The fastest way to reach me is email.</p>
  <ul>
